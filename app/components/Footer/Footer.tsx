    ...
    return (
        ...
        <div className="mx-auto max-w-2xl pt-24 px-4 sm:px-6 lg:max-w-7xl lg:px-8">
            ...
            <div className='py-10 md:flex items-center justify-between border-t border-t-bordertop'>
                <h4 className='text-darkgrey text-sm text-center md:text-start font-normal'>Desde 1994 - Restaurante Papagaio. All Rights Reserved by <Link href="https://alexandre.agency/" target="_blank"> Alexandre Brasil</Link></h4>
