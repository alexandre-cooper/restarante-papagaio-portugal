      ...
      <div className="mx-auto max-w-2xl bg-pink br-50 md:max-w-7xl mt-48 rounded-lg">
        <div className="grid grid-cols-1 gap-y-10 gap-x-6 md:grid-cols-12 xl:gap-x-8">
          ...
          <div className="col-span-7">
            <div className="m-10 lg:ml-32 lg:mt-20 lg:mb-20">
              <Fade
                ...
                triggerOnce={true}
              >
                <h3 className="text-lg font-normal text-black mb-3 ls-51">
                  {" "}
                  NEWSLETTER{" "}
                </h3>
              </Fade>
              <Fade
                ...
                triggerOnce={true}
              >
                <h3 className="text-3xl md:text-5xl font-semibold text-black mb-8">
          ...
          <div className="col-span-5 relative hidden md:block">
            <div>
              <Image
                src={"/images/Newsletter/batatas.png"}
                alt="soup-image"
                width={626}
                height={602}
                className="-mt-24"
            ...
            <div className="absolute top-[30%] right-[-23%] hidden lg:block">
              <Image
                src={"/images/Newsletter/bife.png"}
                alt="lettuce-image"
                width={300}
                height={122}
              />
